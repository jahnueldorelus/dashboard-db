...
CREATE PROCEDURE `update_subscription` (IN user_id INT UNSIGNED, subscription_id INT UNSIGNED,
										occurence_id INT UNSIGNED, company VARCHAR(155), 
										amount DECIMAL(10,2), website VARCHAR(155), 
										due_date DATE)
BEGIN
	UPDATE Subscription SET occurence_id = occurence_id, company = company, amount = amount, website = website, due_date = due_date
